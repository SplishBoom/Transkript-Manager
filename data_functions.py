...
def calculate_gpa(given_course_list):
    """
    This should extract
    credit info, gpa info for given course list.
    to get general info for both just give all courses together.
    to get semester info give courses of that semester.
    """
    pass

# Example usage of functions
modified_course_list = original_course_list.copy()
print(modified_course_list == original_course_list)

modified_course_list = sort_by(modified_course_list, "course_grade", True)
modified_course_list = filter_by(modified_course_list, "course_lang", "TR")
modified_course_list = filter_by(modified_course_list, "course_grade", "A")
modified_course_list = add_course(modified_course_list, "COMP 304", "Operating Systems", "EN", "6", "N/A", "0.00")
modified_course_list = subtract_course(modified_course_list, "COMP 304")
modified_course_list = update_course(modified_course_list, "COMP 304", "Operating Siystums", "ENTER", "61", "N/A/N", "99.9")
